...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-bsfs --disable-devices --disable-encoders --disable-muxers --enable-cross-compile --cross-prefix=arm-none-linux-gnueabi- --arch=armv7-a --cpu=cortex-a8 --target-os=linux --enable-pic
prefix=/usr/local
...
SRC_PATH="/home/luka/Workspace/faplayer/jni/ext/ffmpeg"
SRC_PATH_BARE=/home/luka/Workspace/faplayer/jni/ext/ffmpeg
BUILD_ROOT="/home/luka/Workspace/faplayer/jni/ext/ffmpeg"
CC_IDENT=gcc 4.4.1 (Sourcery G++ Lite 2010q1-202)
ARCH=arm
...
CFLAGS=  -mcpu=cortex-a8 -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS=  -mcpu=cortex-a8 -fPIC -g
CC_O=-o $@
LDFLAGS= -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavcore -Wl,-rpath-link,$(BUILD_ROOT)/libavutil
