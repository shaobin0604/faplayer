...
#define FFMPEG_CONFIGURATION "--disable-bsfs --disable-devices --disable-encoders --disable-muxers --enable-cross-compile --cross-prefix=arm-linux-androideabi- --target-os=linux --enable-pic"
