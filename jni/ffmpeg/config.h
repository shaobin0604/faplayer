...
#define FFMPEG_CONFIGURATION "--disable-bsfs --disable-devices --disable-encoders --disable-muxers --enable-cross-compile --cross-prefix=arm-none-linux-gnueabi- --arch=armv6j --cpu=arm1136j-s --target-os=linux --enable-pic"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "/sdcard/.ffmpeg"
#define CC_TYPE "gcc"
