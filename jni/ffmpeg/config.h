...
#define FFMPEG_CONFIGURATION "--disable-encoders --disable-muxers --enable-cross-compile --cross-prefix=arm-eabi- --arch=armv6j --cpu=arm1136j-s --target-os=linux --enable-pic"
