...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-encoders --disable-muxers --enable-cross-compile --cross-prefix=arm-none-linux-gnueabi- --arch=armv6j --cpu=arm1136j-s --target-os=linux --enable-pic
prefix=/usr/local
