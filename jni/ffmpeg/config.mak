...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-cross-compile --cross-prefix=arm-none-linux-gnueabi- --sysinclude=/opt/android-ndk-r4b/build/platforms/android-4/arch-arm/usr/include --arch=armv6j --cpu=arm1136jf-s --target-os=linux --enable-pic
prefix=/usr/local
...
libavutil_VERSION=50.26.0
libavutil_VERSION_MAJOR=50
libavfilter_VERSION=1.38.3
