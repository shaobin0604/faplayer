...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-bsfs --disable-devices --disable-encoders --disable-muxers --enable-cross-compile --cross-prefix=arm-linux-androideabi- --arch=armv6j --cpu=arm1136j-s --target-os=linux --enable-pic --enable-librtmp
prefix=/usr/local
...
SRC_PATH="/home/luka/Workspace/faplayer/jni/ffmpeg"
SRC_PATH_BARE=/home/luka/Workspace/faplayer/jni/ffmpeg
BUILD_ROOT="/home/luka/Workspace/faplayer/jni/ffmpeg"
...
CFLAGS=-I/opt/google/standalone-android-toolchain/sysroot/include -L/opt/google/standalone-android-toolchain/sysroot/lib  -mcpu=arm1136j-s -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS=  -mcpu=arm1136j-s -fPIC -g
CC_O=-o $@
LDFLAGS=-lrtmp -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavcore -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
...
libavcodec_VERSION=52.94.4
libavcodec_VERSION_MAJOR=52
libavcore_VERSION=0.12.1
