...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-encoders --disable-muxers --enable-cross-compile --cross-prefix=arm-android-linux-gnueabi- --arch=armv6j --cpu=arm1136j-s --target-os=linux --enable-pic
prefix=/usr/local
...
SRC_PATH="/home/luka/Workspace/!/DemoPlayer/jni/ffmpeg"
SRC_PATH_BARE=/home/luka/Workspace/!/DemoPlayer/jni/ffmpeg
BUILD_ROOT="/home/luka/Workspace/!/DemoPlayer/jni/ffmpeg"
CC_IDENT=gcc 4.4.3 (crosstool-NG-1.8.1)
ARCH=arm
CC=arm-android-linux-gnueabi-gcc
AS=arm-android-linux-gnueabi-gcc
LD=arm-android-linux-gnueabi-gcc
DEPCC=arm-android-linux-gnueabi-gcc
YASM=yasm
YASMDEP=yasm
AR=arm-android-linux-gnueabi-ar
RANLIB=arm-android-linux-gnueabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=arm-android-linux-gnueabi-strip
CPPFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS=  -mcpu=arm1136j-s -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
